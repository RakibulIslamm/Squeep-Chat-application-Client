...
const SideBar = () => {
    ...
    return (
        <div className={`${toggle ? 'w-[200px]' : 'w-[60px]'} h-full bg-sidebarBg py-6 flex flex-col justify-between items-center overflow-hidden transition-all ease-in-out duration-300`}>
