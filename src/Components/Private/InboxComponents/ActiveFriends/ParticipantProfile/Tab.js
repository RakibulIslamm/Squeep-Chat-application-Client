...
const Tab = ({ children, icon1, icon2, buttonName }) => {
    ...
    return (
        <div className=' transition-all ease-in-out'>
            ...
            <div className={`w-full overflow-hidden bg-primary ${tabActive.includes(children) ? 'h-full p-3' : 'h-0'}`}>
                {buttonName === 'media' && <p>Media Section</p>}
                {buttonName === 'privacy' && <p>Privacy Section</p>}
